...
PlasmaCore.Dialog {
    ...
    function updateSize() {
        ...
        if (!groupRepeater.count) {
            ...
            maxWidth += units.iconSizes.small + 6;
            ...
            mainItem.width = 3*panel.iconSize;
            ...
            mainItem.height = groupRepeater.count * ( Math.max(theme.mSize(theme.defaultFont).height, units.iconSizes.small));
        }
    }
}
